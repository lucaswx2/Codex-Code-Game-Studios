...
See `docs/codex/refs/director-gates.md` for the full check pattern and mode definitions.
...
Spawn `qa-lead` via the relevant /agent-<name> Codex prompt using gate **QL-STORY-READY** (`docs/codex/refs/director-gates.md`).
