...
After completing the deviation checks in Phase 4, spawn `qa-lead` via the relevant /agent-<name> Codex prompt using gate **QL-TEST-COVERAGE** (`docs/codex/refs/director-gates.md`).
...
Spawn `lead-programmer` via the relevant /agent-<name> Codex prompt using gate **LP-CODE-REVIEW** (`docs/codex/refs/director-gates.md`).
