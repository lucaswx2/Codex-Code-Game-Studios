...
| `validate-skill-change.sh` | PostToolUse (Write/Edit) | Skill file changes | Advises running `/skill-test` after any `.codex/prompts/` file is written or edited |

Hook reference documentation: `docs/codex/refs/hooks-reference/`
Hook input schema documentation: `docs/codex/refs/hooks-reference/hook-input-schemas.md`
