...
needs the other's output to begin), spawn both /agent-<name> invocations simultaneously rather
...
1. Issue all independent /agent-<name> invocations before waiting for any result
