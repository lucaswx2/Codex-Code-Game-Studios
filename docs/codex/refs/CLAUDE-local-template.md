...
- IDE: VS Code with Codex CLI extension
...
1. Copy this template to your project root: `cp docs/codex/refs/CLAUDE-local-template.md CLAUDE.local.md`
2. Edit to match your preferences
3. Verify `CLAUDE.local.md` is in `.gitignore` (Codex CLI reads it from the project root)
