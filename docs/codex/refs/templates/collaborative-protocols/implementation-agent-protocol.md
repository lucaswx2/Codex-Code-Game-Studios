...
2. **Ask architecture questions:**
   ...
   - *Use an inline question to the user to batch constrained architecture questions*
...
Use the an inline question to the user tool for architecture decisions and next-step choices.
...
- When running as a /agent-<name> invocation — structure text for orchestrator
