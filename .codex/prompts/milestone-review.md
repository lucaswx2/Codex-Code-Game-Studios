...
Before generating the Go/No-Go recommendation, spawn `producer` via the relevant /agent-<name> Codex prompt using gate **PR-MILESTONE** (`.claude/docs/director-gates.md`).
