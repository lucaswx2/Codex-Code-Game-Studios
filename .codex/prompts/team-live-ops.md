...
> Codex slash-prompt. Originally derived from `.claude/skills/team-live-ops/SKILL.md`.
...
Use the /agent-team-live-ops prompt to spawn each team member as a subagent:
