...
1. Check `docs/codex/refs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `docs/codex/refs/templates/patch-notes-template.md`.
