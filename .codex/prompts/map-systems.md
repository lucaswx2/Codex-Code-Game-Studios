...
**After dependency mapping is approved, spawn `technical-director` via the relevant /agent-<name> Codex prompt using gate TD-SYSTEM-BOUNDARY (`docs/codex/refs/director-gates.md`) before proceeding to priority assignment.**
...
**After priorities are approved, spawn `producer` via the relevant /agent-<name> Codex prompt using gate PR-SCOPE (`docs/codex/refs/director-gates.md`) before writing the index.**
...
Using the template at `docs/codex/refs/templates/systems-index.md`, populate the
...
**After the systems index is written, spawn `creative-director` via the relevant /agent-<name> Codex prompt using gate CD-SYSTEMS (`docs/codex/refs/director-gates.md`).**
