...
Validates `.codex/prompts/*.md` files for structural compliance and
...
- `static all` → run 7 structural checks on all skills (Glob `.codex/prompts/*.md`)
...
Glob `.codex/prompts/*.md` to get the complete list of skills.
