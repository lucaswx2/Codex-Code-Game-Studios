...
Verify `.codex/prompts/[name].md` exists. If not, stop with:
...
Read the full skill file at `.codex/prompts/[name].md`.
...
Ask: "May I write this improved version to `.codex/prompts/[name].md`?"
...
Write the improved skill to `.codex/prompts/[name].md`.
...
Ask: "May I revert `.codex/prompts/[name].md` using git checkout?"
If yes: run `git checkout -- .codex/prompts/[name].md`
